...
if( not versioncheck) then
	...
	Controls.PitbossButton:SetToolTipString("La tua versione è sbagliata, si prega di settare la versione tramite setpatch.bat o installazione. Grazie.");
end
--Controls.PitbossButton:SetText("PitBoss V 1");
--Controls.VersionNumber:SetText(versionNumber .. UI.GetVersionInfo() .. "Versione Giusta");
-------------------------------------------------
-- Helper Functions
-------------------------------------------------
